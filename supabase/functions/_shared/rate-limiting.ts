...
export const limiters = {
  ...
  deductCall: new RateLimiter(60000, 60),
  ...
  generateToken: new RateLimiter(60000, 100),
  refund: new RateLimiter(60000, 10),
  verifyPayment: new RateLimiter(60000, 10),
  razorpayWebhook: new RateLimiter(60000, 30),
};
